...
public class SharePictureTabFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imgShare.setOnClickListener(SharePictureTabFragment.this);
        btnShareImage.setOnClickListener(SharePictureTabFragment.this);
                        ...
                        parseObject.saveInBackground(new SaveCallback() {
                            ...
                            public void done(ParseException e) {
                                if (e == null) {
                                    ...
                                    FancyToast.makeText(getContext(), "Unknown eror: " + e.getMessage(), Toast.LENGTH_SHORT, FancyToast.ERROR, true).show();
                                }
                                dialog.dismiss();
                            }
                        });
